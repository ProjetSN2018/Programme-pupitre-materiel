...
const t_menu _OneDoorMenu[] = {		//Choix des modes 1 porte							//Menu permettant de choisir le mode pour le cas où il n'y a qu'une porte
	...
	{"Deverrouillage",	_menuPairingUneP,	NULL,				_modeDeverrouillage},	//Mode Déverrouillage, amène vers la fonction de mode Déverrouillage
	{"Blocage",			_menuPairingUneP,	NULL,				_modeBlocage},			//Mode Blocage, amène vers la fonction de mode Blocage
	{"Controle Entree",	_menuPairingUneP,	NULL,				_modeControleE},		//Mode Contrôle Entrée, amène vers la fonction de mode Contrôle Entrée
	{"Controle E/S",	_menuPairingUneP,	NULL,				_modeControleES},		//Mode Contrôle E/S, amène vers la fonction de mode Contrôle E/S
...
const t_menu _TwoDoorMenu[] = {		//Choix des modes 2 portes							//Menu permettant de choisir le mode pour le cas où il y deux portes
	...
	{"Deverrouillage",	_menuPairingDeuxP,	NULL,				_modeDeverrouillage},	//Mode Déverrouillage, amène vers la fonction de mode Déverrouillage
...
const t_menu _ThreeDoorMenu[] = {	//Choix des modes 3 portes ou plus					//Menu permettant de choisir le mode pour le cas où il y a trois portes ou plus
	...
	{"Deverrouillage",			_menuPairingTroisP,	NULL,		_modeDeverrouillage},	//Mode Déverrouillage,
	{"Blocage",					_menuPairingTroisP,	NULL,		_modeBlocage},			//Mode Blocage,
	{"Ctrl personnalise",		_menuPairingTroisP,	NULL,		_modeCtrlPerso},		//Mode Contrôle personnalisé,
	//Affichage LCD,			Menu précédent,		Sous-menu,	Fonction de ce champ//
	//////////////////////////////////////////////////////////////////////////////////
	{ NULL, NULL, NULL	}
};
